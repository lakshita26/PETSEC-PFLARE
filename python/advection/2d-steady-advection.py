...
# --------------------------------------------------
# Print full matrix (WARNING: very large for 100x100)
# --------------------------------------------------
...
# Print default tolerances (no setting!)
rtol, atol, dtol, max_it = ksp.getTolerances()

print("\nDefault PETSc solver tolerances:")
print("Relative tolerance (rtol):", rtol)
print("Absolute tolerance (atol):", atol)
print("Divergence tolerance (dtol):", dtol)
print("Maximum iterations:", max_it)
