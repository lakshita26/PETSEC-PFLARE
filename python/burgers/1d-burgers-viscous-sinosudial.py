...
# ========================================================
# 8. INITIAL CONDITION (SINUSOIDAL)
# ========================================================
...
if PETSc.COMM_WORLD.getRank() == 0:
    print("Running 1D viscous Burgers (IMEX)...\n")

ts.solve(X)

# ========================================================
# 10. PRINT FINAL ITERATION COUNTS  (⭐ ADDED ⭐)
# ========================================================
if PETSc.COMM_WORLD.getRank() == 0:
    print("\n===== Solver Statistics =====")
...
if PETSc.COMM_WORLD.getRank() == 0:
    ...
    plt.xlabel("x")
    plt.ylabel("u(x)")
    plt.title("1D Viscous Burgers (IMEX)")
    plt.tight_layout()
    plt.savefig("burgers_1d_imex.png", dpi=150)
    plt.close()

    print("Saved burgers_1d_imex.png")
