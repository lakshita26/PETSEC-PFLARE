...
# ani.save("1d-burgers-implicit-viscous-tophat.gif", dpi=150)
# plt.close()

# print("\nAnimation saved as 1d-burgers-implicit-viscous-tophat.gif")
...
plt.tight_layout()
plt.savefig("1d-burgers-implicit-viscous-tophat-surface.png", dpi=150)
plt.close()

print("\nAnimation saved as 1d-burgers-implicit-tophat.gif")
print("3D surface plot saved as 1d-burgers-implicit-viscous-tophat-surface.png")