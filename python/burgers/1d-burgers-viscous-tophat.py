...
if PETSc.COMM_WORLD.getRank() == 0:
    print("Running 1D viscous Burgers (Top-Hat IC, IMEX)...\n")
...
if PETSc.COMM_WORLD.getRank() == 0:
    ...
    plt.xlabel("x")
    plt.ylabel("u(x)")
    plt.title("1D Viscous Burgers (Top-Hat IC)")
    plt.tight_layout()
    plt.savefig("burgers_1d_viscous_tophat.png", dpi=150)
    plt.close()

    print("Saved burgers_1d_viscous_tophat.png")
