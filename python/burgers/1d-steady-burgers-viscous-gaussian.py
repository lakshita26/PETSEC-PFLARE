...
plt.tight_layout()
plt.savefig("1d-steady-burgers-viscous-implicit-gaussian.png", dpi=150)
plt.close()

print("\nSaved plot as 1d-steady-burgers-viscous-implicit-gaussian.png")
...
if len(solution_history) > 1:
    ...
    ani.save("1d-steady-burgers-viscous-implicit-gaussian.gif", dpi=150)
    plt.close()
    print("Animation saved as 1d-steady-burgers-viscous-implicit-gaussian.gif")
