...
ani.save("1d-burgers-implicit-tophat.gif", dpi=150)
plt.close()

print("\nAnimation saved as 1d-burgers-implicit-tophat.gif")
...
ax.set_ylabel("time")
ax.set_zlabel("u(x,t)")
ax.set_title("InViscous Burgers Equation (Implicit)")

fig.colorbar(surf, shrink=0.5, aspect=12)
plt.tight_layout()
plt.savefig("1d-burgers-implicit-tophat-surface.png", dpi=150)
plt.close()

print("\nAnimation saved as 1d-burgers-tophat.gif")
print("3D surface plot saved as 1d-burgers-implicit-tophat-surface.png")